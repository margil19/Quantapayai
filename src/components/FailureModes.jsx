    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-muted">
          Four failure scenarios across four failure categories. The integration is designed to fail loudly - never silently. Click any card to expand the full incident detail.
        </p>
      </div>
