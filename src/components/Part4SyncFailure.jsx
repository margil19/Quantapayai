  ...
  if (dismissed) {
    return (
      <div className="space-y-6">
        ...
        <div className="bg-[#f5f6fa] min-h-[300px] rounded-2xl overflow-hidden border border-gray-200 shadow-sm flex flex-col">
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 space-y-3">
            ...
            <p className="text-base font-semibold text-dark">Flag dismissed - record handed off manually</p>
            <p className="text-sm text-muted text-center max-w-sm">Sarah Chen's salary update is still blocked. Your HR team will need to resolve it directly in Workday before the June 30 payroll run.</p>
            <div className="bg-amber-50 border border-amber-200 rounded-lg px-4 py-2 text-xs text-amber-700 text-center max-w-sm">
              ⚠ Payroll deadline: June 30 - 2 days remaining
            </div>
            <button onClick={() => setDismissed(false)} className="text-xs text-primary border border-primary/30 rounded-lg px-3 py-1.5 hover:bg-purple-50 transition-colors mt-2">
              Reset demo
            </button>
          </div>
        </div>
